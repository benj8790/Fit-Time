...
db.adherent.hasMany(db.programme, { foreignkey: "AdherentId" });
...
db.adherent.hasMany(db.suivi, { foreignkey: "AdherentId" });
//db.suivi.belongsTo(db.adherent, { foreignKey: "AdherentId" });

/////////////////////////////////////////////////////////////////////////////////////

//toutes les relations avec table intermediaire
db.coach_categorie.belongsToMany(db.coach_sous_categorie, {
    through: "Disposer",
    foreignKey: "Coach_CategorieId",
});
db.coach_sous_categorie.belongsToMany(db.coach_categorie, {
    through: "Disposer",
    foreignKey: "coach_sous_categorieId",
});

db.coach.belongsToMany(db.coach_sous_categorie, {
    through: "Appartenir",
    foreignKey: "CoachId",
});
db.coach_sous_categorie.belongsToMany(db.coach, {
    through: "Appartenir",
    foreignKey: "coach_sous_categorieId",
});

db.cours_collectif.belongsToMany(db.inscription, {
    through: "Enregistrer",
    foreignKey: "Cours_CollectifId",
});
db.inscription.belongsToMany(db.cours_collectif, {
    through: "Enregistrer",
    foreignKey: "InscriptionId",
});

db.borne.belongsToMany(db.adherent, {
    through: "Dependre",
    foreignKey: "BorneId",
});
db.adherent.belongsToMany(db.borne, {
    through: "Dependre",
    foreignKey: "AdherentId",
});

db.abonnement.belongsToMany(db.statistique, {
    through: "Concerner",
    foreignKey: "AbonnementId",
});
db.statistique.belongsToMany(db.abonnement, {
    through: "Concerner",
    foreignKey: "StatistiqueId",
});

db.salle_de_sport.belongsToMany(db.formule_essaie, {
    through: "Etre",
    foreignKey: "Salle_de_SportId",
});
db.formule_essaie.belongsToMany(db.salle_de_sport, {
    through: "Etre",
    foreignKey: "Formule_EssaieId",
});

db.salle_de_sport.belongsToMany(db.abonnement, {
    through: "Attribuer",
    foreignKey: "Salle_de_SportId",
});
db.abonnement.belongsToMany(db.salle_de_sport, {
    through: "Attribuer",
    foreignKey: "AbonnementId",
});

db.formule_essaie.belongsToMany(db.planning, {
    through: "Programmer",
    foreignKey: "Formule_EssaieId",
});
db.planning.belongsToMany(db.formule_essaie, {
    through: "Programmer",
    foreignKey: "PlanningId",
});

db.adherent.belongsToMany(db.annonce, {
    through: "Publier",
    foreignKey: "AdherentId",
});
...
db.cours_en_ligne.belongsToMany(db.inscription, {
    through: "Affecter",
    foreignKey: "Cours_en_LigneId",
});
db.inscription.belongsToMany(db.cours_en_ligne, {
    through: "Affecter",
    foreignKey: "InscriptionId",
});
